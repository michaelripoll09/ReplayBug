...
artifact-deletion outbox, and expands the audit action constraint for
governance, retention, and deletion lifecycle actions. Migration `0008` adds
AI analysis history and its durable dispatch outbox.
...
`0006` → `0007` migration boundary. These are migration-path tests, not schema
